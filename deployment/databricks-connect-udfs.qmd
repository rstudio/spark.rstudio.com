...
| `fetch_result_as_sdf`         | Yes        | At this time, `spark_apply()` inside Databricks Connect only supports rectangular data, so setting it to `FALSE` will always return a data frame.                                                                                                                                                                                                                                                                                                        |
...
a different Operating System than the cluster. Additionally,
