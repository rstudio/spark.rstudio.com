...
<p><img src="images/spark-sa-setup.png" width='600px' align='center'/></p>
...
Next you need to setup add a password to the certificate on the “Key Pair” downloaded from AWS. Amazon provides the step-by-step instructions for this part:

- Windows – Use the sections "Converting Your Private Key Using PuTTYgen" and "Starting a PuTTY Session" in the  [AWS User Guide](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/putty.htmlComplete sections)
    
- Non-Windows – [AWS User Guide](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AccessingInstancesLinux.html). Only go through the instructions in the "To connect to your instance using SSH"" section.
