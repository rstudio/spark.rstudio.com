...
For additional details, refer to the
  [FAQ for RStudio on Databricks](https://docs.databricks.com/spark/latest/sparkr/rstudio.html#frequently-asked-questions-faq).
...
Use the following commands in the RStudio IDE to establish a connection from
`sparklyr` to the Databricks cluster:
