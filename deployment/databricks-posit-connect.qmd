...
-   If you know the cluster's DBR version:
    ...
    ``` r
    pysparklyr::deploy_databricks(version = "18.1")
    ```
...
-   The cluster's ID can also be used and `pysparklyr` will
    ...
    ``` r
    pysparklyr::deploy_databricks(cluster_id = "0415-180932-gzusyghs")
    ```
...
-   You can also pass the path to the Python environment to use by
    ...
    ``` r
    pysparklyr::deploy_databricks(python = "/Users/edgar/.virtualenvs/r-sparklyr-databricks-18.1")
    ```
...
ℹ Python: /Users/edgar/.virtualenvs/r-sparklyr-databricks-18.1/bin/python
