...
use your user name and password to authenticate (basic authentication)

- The next  option is to obtain a **Personal Authorization Token (PAT)**, which 
...
variables at the **user level**. If missing, insert the require entries on the
...
ID already populated, as well as the Host URL. In the background, the snipped 
