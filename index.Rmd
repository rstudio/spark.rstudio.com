...
- Orchestrate distributed machine learning from R using either [Spark MLlib](mllib.html) or [H2O SparkingWater](h2o.html).
...
You can orchestrate machine learning algorithms in a Spark cluster via either [Spark MLlib](mllib.html) via the [H2O Sparkling Water](h2o.html) extension package. Both provide a set of high-level APIs built on top of DataFrames that help you create and tune machine learning workflows. 
...
H2O Sparking Water supports a wide array of algorithms, and as illustrated above it's easy to chain these functions together with dplyr pipelines. To learn more see the [H2O Sparking Water](h2o.html) section.
