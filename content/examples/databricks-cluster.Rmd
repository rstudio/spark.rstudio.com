...
- Option 1 (Preferred option): [Connecting to Databricks remotely](#option-1---connecting-to-databricks-remotely)
...
With this configuration, RStudio Server Pro is installed outside of the Spark cluster
and connects to Spark remotely using Databricks Connect.
