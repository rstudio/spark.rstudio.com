...
There are several options to obtain your credentials. Choose one from the following,
presented in order of simplicity: 
...
- If not working in Posit Workbench, the next easiest option is to obtain a **Personal 
Authorization Token (PAT)**, which will act as both your "user ID", and your 
"password" to gain access. See the Databricks docs to find out how to [obtain
a PAT](https://docs.databricks.com/dev-tools/auth.html#pat)
