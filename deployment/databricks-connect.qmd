...
flowchart LR
  ...
  style r   fill:#cff,stroke:#666
  style sr  fill:#444,stroke:#666,color:#fff
  style rt  fill:#036,stroke:#666,color:#fff
  style ps  fill:#ffc,stroke:#666
  style lp  fill:#fff,stroke:#666,color:#fff
  style db  fill:#c66,stroke:#666,color:#fff
  style sp  fill:#fcc,stroke:#666,color:#000
  style g1  fill:#ff0,stroke:#666
  style dc  fill:#ff0,stroke:#666
```
