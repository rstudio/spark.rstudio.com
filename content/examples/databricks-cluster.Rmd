...
- **Connect to Databricks remotely** - Work with Databricks as a remote compute
  ...
  and Impala, or the JDBC/ODBC server in Databricks on
...
1. By accessing data via ODBC with the
   [RStudio Professional Drivers](https://docs.rstudio.com/pro-drivers/) for
   Hive and Impala or the JDBC/ODBC server in Databricks on
   [AWS](https://docs.databricks.com/integrations/bi/jdbc-odbc-bi.html) or
   [Azure](https://docs.microsoft.com/en-us/azure/databricks/integrations/bi/jdbc-odbc-bi)
   (Recommended Option)
2. By connecting to Databricks remotely using
   [Databricks Connect](https://docs.databricks.com/dev-tools/databricks-connect.html)
   (Alternative Option)
3. By adding calls in your R code to create and run Databricks jobs
