...
You can now connect by simply providing the cluster ID, and the method to 
`spark_connect()`:
...
of [Python libraries](#additional-setup-details). To make it easier to get started, we provide functionality
