...
sparklyr uses the [dplyr](https://github.com/hadley/dplyr) semantics for interacting with data which enables you to perform dplyr operations on data hosted in Spark. If you have a dataset available in Spark, you can interact with it just as you would any other dplyr data source. For more advanced usage, refer to the [dplyr section](dplyr.html).
