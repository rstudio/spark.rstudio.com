...
- RStudio Workbench will remain functional if Databricks clusters are
  terminated
...
to install Python on the same server where RStudio Workbench is installed.
...
a terminal when logged in as a user in RStudio Workbench:
