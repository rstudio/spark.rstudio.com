...
thing that will change more often is the cluster you are connecting to.  We
recommend that you set these two variables at your **user level**. To do this run:

```r
usethis::edit_r_environ()
```

That command will open the file that controls the environment variables at
...
- Update restricted environments, envname instead of environment variable
