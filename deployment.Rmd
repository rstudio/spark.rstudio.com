...
There are two well supported deployment modes for **sparklyr**: developing locally (typically on the desktop with smaller/sampled datasets) and working directly within or alongside a Spark cluster via SSH or RStudio Server.
