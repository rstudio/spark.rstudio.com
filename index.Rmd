...
## Connecting to Spark {.tabset .tabset-fade}
...
Below there are instructions for connecting to either a local Spark instance or for using sparklyr within a cluster. For additional information see the [Deployment](deployment.html) section.
