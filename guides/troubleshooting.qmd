...
If it seems that current version of the package has a bug, or the new functionality does not perform as stated, please refer to the `sparklyr` [ISSUES](https://github.com/sparklyr/sparklyr/issues) page.  If no existing issue matches to what your problem is, please open a new issue.
