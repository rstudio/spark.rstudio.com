...
<img src="images/examples-emr/workflowShare.png" width=`r params$width`/>
...
<p><img src="images/examples-emr/emrArchitecture.png" width=`r params$width`/></p>
...
<img src="images/examples-emr/awsNewSecurityGroup.png" width=`r params$width`/>
...
<img src="images/examples-emr/emrConfigStep1.png" width=`r params$width`/>
...
<img src="images/examples-emr/emrConfigStep2.png" width=`r params$width`/>
...
<img src="images/examples-emr/emrConfigStep3.png" width=`r params$width`/>
...
<img src="images/examples-emr/emrConfigStep4.png" width=`r params$width`/>
...
<img src="images/examples-emr/awsClusterConnect.png" width=`r params$width`/>
...
<img src="images/examples-emr/emrLogin.png" width=`r params$width`/>
...
<p><img src="images/examples-emr/rstudioLogin.png" width=`r params$width`/></p>
...
<p><img src="images/examples-emr/rstudioSparkPane.png" width=`r params$width`/></p>

You can inspect your tables by clicking on the data icon.

<p><img src="images/examples-emr/rstudioData.png" width=`r params$width`/></p>
...
<p><img src="images/examples-emr/rstudio.png" width=`r params$width`/></p>
...
<p><img src="images/examples-emr/performance-1.png" width=`r params$width`/></p>
...
<p><img src="images/examples-emr/forecast-1.png" width=`r params$width`/></p>
...
<img src="images/examples-emr/flightsDashboard.png" width=`r params$width`/>
</a>
</p>
