...
You can install Spark by running the following commands in the RStudio IDE:
...
You can connect to the Databricks cluster by running the following commands in
the RStudio IDE:
