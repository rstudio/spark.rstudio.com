...
|[stream_read_csv() stream_read_text() stream_read_json() stream_read_parquet() stream_read_orc() stream_read_kafka() stream_read_socket() stream_read_delta() stream_read_cloudfiles() stream_read_table()](/packages/sparklyr/latest/reference/stream_read_csv.html)|Read files created by the stream|
...
|[stream_write_csv() stream_write_text() stream_write_json() stream_write_parquet() stream_write_orc() stream_write_kafka() stream_write_console() stream_write_delta()](/packages/sparklyr/latest/reference/stream_write_csv.html)|Write files to the stream|
|[stream_write_memory()](/packages/sparklyr/latest/reference/stream_write_memory.html)|Write Memory Stream|
|[stream_write_table()](/packages/sparklyr/latest/reference/stream_write_table.html)|Write Stream to Table|
...
|[tidy(<i><ml_model_generalized_linear_regression></i>) tidy(<i><ml_model_linear_regression></i>) augment(<i><ml_model_generalized_linear_regression></i>) augment(<i><_ml_model_linear_regression></i>) augment(<i><ml_model_linear_regression></i>) glance(<i><ml_model_generalized_linear_regression></i>) glance(<i><ml_model_linear_regression></i>)](/packages/sparklyr/latest/reference/ml_glm_tidiers.html)|Tidying methods for Spark ML linear models|
...
|[tidy(<i><ml_model_logistic_regression></i>) augment(<i><ml_model_logistic_regression></i>) augment(<i><_ml_model_logistic_regression></i>) glance(<i><ml_model_logistic_regression></i>)](/packages/sparklyr/latest/reference/ml_logistic_regression_tidiers.html)|Tidying methods for Spark ML Logistic Regression|
...
|[tidy(<i><ml_model_decision_tree_classification></i>) tidy(<i><ml_model_decision_tree_regression></i>) augment(<i><ml_model_decision_tree_classification></i>) augment(<i><_ml_model_decision_tree_classification></i>) augment(<i><ml_model_decision_tree_regression></i>) augment(<i><_ml_model_decision_tree_regression></i>) glance(<i><ml_model_decision_tree_classification></i>) glance(<i><ml_model_decision_tree_regression></i>) tidy(<i><ml_model_random_forest_classification></i>) tidy(<i><ml_model_random_forest_regression></i>) augment(<i><ml_model_random_forest_classification></i>) augment(<i><_ml_model_random_forest_classification></i>) augment(<i><ml_model_random_forest_regression></i>) augment(<i><_ml_model_random_forest_regression></i>) glance(<i><ml_model_random_forest_classification></i>) glance(<i><ml_model_random_forest_regression></i>) tidy(<i><ml_model_gbt_classification></i>) tidy(<i><ml_model_gbt_regression></i>) augment(<i><ml_model_gbt_classification></i>) augment(<i><_ml_model_gbt_classification></i>) augment(<i><ml_model_gbt_regression></i>) augment(<i><_ml_model_gbt_regression></i>) glance(<i><ml_model_gbt_classification></i>) glance(<i><ml_model_gbt_regression></i>)](/packages/sparklyr/latest/reference/ml_tree_tidiers.html)|Tidying methods for Spark ML tree models|
