...
For more information visit the [Databricks](/deployment/databricks-connect.qmd) page 

**Snowflake**: 

```r
sc <- spark_connect(method = "snowpark_connect")
```

For more information visit the [Snowflake](/deployment/snowflake.qmd) page 
...
For more information visit the [Spark Connect](/deployment/spark-connect.qmd) page 

**Legacy:**

- **Mesos** *(removed in Spark 3.2)*: `sc <- spark_connect(master = "mesos://host:port")`

- **[Qubole](/deployment/qubole-overview.qmd)**: `sc <- spark_connect(method = "qubole")`

- **Livy**: `sc <- spark_connect(master = "http://server/livy", method = "livy")`
