...
execute:
    ...
    freeze: false
aliases:
  - /examples/databricks-cluster.html
---
...
![](/images/deployment/databricks/rstudio-databricks-architecture.png)
...
-   Option 1: [Connecting to Databricks remotely](#option-1---connecting-to-databricks-remotely) (Recommended Option)
-   Option 2: [Working inside of Databricks](#option-2---working-inside-of-databricks) (Alternative Option)

### Option 1 - Connecting to Databricks remotely {#option-1---connecting-to-databricks-remotely}

With this configuration, RStudio Workbench is installed outside of the Spark cluster and allows users to connect to Spark remotely using `sparklyr` with [Databricks Connect](https://docs.databricks.com/dev-tools/databricks-connect.html).
...
Follow this article for steps on how to do this: [Option 1 - Connecting to Databricks remotely](/deployment/databricks-cluster-remote.qmd)

### Option 2 - Working inside of Databricks {#option-2---working-inside-of-databricks}
...
Follow this article for steps on how to do this: [Option 2 - Working inside of Databricks](/deployment/databricks-cluster-local.qmd)
...
1.  [Performing SQL queries with ODBC using the Databricks Spark SQL Driver](/deployment/databricks-cluster-odbc) (Recommended Option).
2.  Adding calls in your R code to create and run Databricks jobs [with bricksteR and the Databricks Jobs API](https://github.com/RafiKurlansik/bricksteR/) (Alternative Option)
