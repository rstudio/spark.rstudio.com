...
**dplyr** is an R package for working with structured data both in and outside of R. dplyr makes data manipulation for R users easy, consistent, and high performant. With dplyr as an interface to manipulating Spark data frames you can:
