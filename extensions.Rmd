...
| Function | Description  |
|----------------------------|---------------------------------------------|
| [`spark_connection`](reference/sparkapi/latest/spark_connection.html) | Get the Spark connection associated with objects of various types. |
...
| [`spark_jobj`](reference/sparkapi/latest/spark_jobj.html) | Get the Spark jobj associated with objects of various types. |
...
When including a JAR file within an R package distributed on CRAN you should follow the guidlines provided in [Writing R Extensions](https://cran.r-project.org/doc/manuals/r-release/R-exts.html#Non_002dR-scripts-in-packages):
