...
- Filter and aggregate Spark datasets</b> then bring them into R for analysis and visualization.
...
```{r, eval=TRUE, echo=FALSE}
  div(class = "col-sm-6", img(src="images/sparklyr-illustration-hd.png"))
```
...
If you use the RStudio IDE, you should also download the  [latest version](https://www.rstudio.com/products/rstudio/download/) of the IDE which includes several enhancements for interacting with Spark (see the [RStudio IDE](#rstudio-ide) section below for more details).
...
The [latest RStudio Release](https://www.rstudio.com/products/rstudio/download/) of the RStudio IDE includes integrated support for Spark and the sparklyr package, including tools for:
...
The RStudio IDE features for sparklyr are available now as part of the [latest RStudio Release](https://www.rstudio.com/products/rstudio/download/).
