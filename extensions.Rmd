...
| [`spark_version`](reference/sparkapi/latest/spark_version.html) | Get the version of Spark (as a `numeric_version`) for a `spark_connection` |
...
| Function | Description  |
|----------------------------|---------------------------------------------|
| [`spark_dependency`](reference/sparkapi/latest/spark_dependency) | Define a Spark dependency consisting of JAR files and Spark packages |
