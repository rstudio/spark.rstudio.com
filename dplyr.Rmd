...
* Operate on a DataFrame (select, filter, aggregate, etc.)
...
When doing simple mathematical operations of the form you normally use when filtering, mutating and summarising it’s relatively straightforward to translate R code to SQL (or indeed to any programming language). dplyr knows how to convert the following R functions to Spark SQL:
