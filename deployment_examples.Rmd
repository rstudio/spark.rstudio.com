...
```{r, echo=FALSE}
div(class = "col-sm-6","sparklyr makes it easy to start using and learning Spark. The package enables the installation and interaction of a Spark locally in a single computer, including on computers with the Microsoft Windows OS.
...
thumbnail("Local Mode", "images/examples-local/storage-4.png", "examples-local.html")
```
