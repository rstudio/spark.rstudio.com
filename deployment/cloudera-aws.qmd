...
This demonstration is focused on adding RStudio integration to an existing Cloudera cluster. The assumption will be made that no aid is needed to setup and administer the cluster.
...
The default Spark 1.6.0 parcel is installed and running
...
This simple linear model contains a wealth of detailed information about carriers, distances traveled, and flight delays. These detailed insights can be conveyed to a non-technical audience via an interactive [flexdashboard](http://rmarkdown.rstudio.com/flexdashboard/index.html).
