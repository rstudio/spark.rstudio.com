...
- **Load and query results efficiently** - Because of the nature of the Spark
  computation, Shiny apps that use Spark on the backend tend to have performance
  and runtime issues; instead, consider reading the results from a database,
  file system, or cloud storage instead
