...
The 2008 and 2007 Flights data from the Statistical Computing site will be used for this exercise.  The **spark_read_csv** function supports compressed CSV files in a **bz2** format, so there's no need to expand the files.
...
Access the Spark Web UI by clicking the **Spark UI button** in the **RStudio Spark tab**. Once there, in the **Executors** page we can see that the Storage Memory is at about half of the 16 gigabytes requested.  This is mainly because of a Spark setting called **spark.memory.fraction**, which reserves by default 40% of the memory requested.
...
<center><a href="images/examples-local/new-plot.png">
  <img src="images/examples-local/new-plot.png", width="600"/>
</a></center>
